...
public class Respuesta  implements java.io.Serializable {
    ...
    /**
     * Gets the retDesc value for this Respuesta.
     * 
     * @return retDesc
     */
    ...
    /**
     * Sets the retDesc value for this Respuesta.
     * 
     * @param retDesc
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://osbservicios.clarochile.cl/PlataformaPagoNotificar/", "Respuesta"));
