...
public class Tarjeta extends MedioPago implements ITrxBase{
    ...
    public int execute(ICajaView vista, int key, Datos datos){ 
        ...
        switch( estado ) {
            case 0:
                ...
                //long mon= vista.getOperTRV().getCarroMediosPago().get
            ...
            case 1:
                ...
                try {
                	...
                	Base.tbk.inicializa(posDat.getStringValue("TransbankConfig"));
			         ...
			         Base.logger.error("No se pudo realizar la inicializacion del pinpad");
			         JOptionPane.showMessageDialog(null, "Error en el pago Multi-Concentrador", "Error", JOptionPane.INFORMATION_MESSAGE);
			         return 13;
                }
                ...
                if (respLeer != null){
	            		...
	            		codTbkReturn=url.getValor("AUTRET")==null?null:url.getValor("AUTRET");
		        		...
		        		if (url.getValor("TXCRET") == null || "00".equalsIgnoreCase(url.getValor("TXCRET"))) {		        			
		        			if (url.getValor("SOLICITAULTDIGITOS").equalsIgnoreCase("Y")) {
		        				System.out.println("Ultimos 4 digitos necesarios");
		        				vista.hideBusyWindow();
		        				...
		        				System.out.println("4 digitos no son necesarios");
		        			...
		        			vista.hideBusyWindow();
		        			String mensaje = "";
		        			respLeer=Format.formatMsjTbk(respLeer);

		        			if (respLeer.contains("tecla Cancel/Timeout")){
//		        				mensaje = "RetTbk [" + codTbkReturn + "]. Operación Cancelada";
		        				mensaje = "RetTbk [" + codTbkReturn + "]. " + msgTbkReturn;
		        			}else{
				        			if (respLeer.contains("comunicacion")){
//				        				mensaje = "RetTbk [" + codTbkReturn + "]. Error de Comunicación Con el Pinpad";
				        				mensaje = "RetTbk [" + codTbkReturn + "]. " + msgTbkReturn;
				        			}
				        			else{
//				        				mensaje = "RetTbk [" + codTbkReturn + "]. Error en el pago Multi-Concentrador";
				        				mensaje = "RetTbk [" + codTbkReturn + "]. " + msgTbkReturn;
				        			}
				        	}
		                    Base.logger.error("No se pudo realizar el pago");
		                    JOptionPane.showMessageDialog(null, mensaje.length()>100?Format.formatText(mensaje):mensaje, "Error",
            ...
            case 3:            
            	...
            	if( vista.showMyConfirmDialog("Confirme por favor","Está seguro de continuar?") == JOptionPane.OK_OPTION ) {
            		...
            		datosFileNet.setEmail_para(vista.getDatos().getStringValue("emails"));
...
//                    }
            ...
            case 5:
            	 ...
            	 respVC = ventaCredito(ultdigTrj,(int)this.data.getLongValue("Monto")+"", tipoTarjeta, "CL", respLeer);
            	 estado = 2;
		            	...
		            	if(respVC.contains("AUTRET") && respVC.contains("TXCRET")){
			            	 if(urlVC.getValor("TXCRET").equals("00") 
			            		...
			            		if (!urlVC.getValor("VOUCHERPREMIO").equalsIgnoreCase("")) {
			                     ...
			                     mensaje="RetTbk [" + codTbkReturn + "]." + Format.formatMsjTbk(mensaje);
			                     ...
			                     JOptionPane.showMessageDialog(null, 
			                    		 mensaje.length()>100?Format.formatText(mensaje):mensaje
...
//                     JOptionPane.showMessageDialog(null, mensaje, "Error", JOptionPane.INFORMATION_MESSAGE);
            	 ...
            	 vista.hideBusyWindow();
                 this.data.setValue("Monto", montoP);
                ...
                // this.data.setValue("NumeroTarjeta", leerAux.getValor("BIN"));
                 ...
                 this.data.setValue("CodigoAutorizacion", urlVC.getValor("AUTCOD"));
                 Base.logger.info("CodigoAutorizacion: "+this.data.getStringValue("CodigoAutorizacion").replaceAll("%20",""));
                 ...
                 } else { // Esta opcion debiese ser para Tarjetas Multitiendas ????
                ...
                Date efchaTbk =	 formatFecha(urlVC.getValor("FECTBK"));
             	...
             	/*
             	 * [REspinoza] Guardar para la solicitud de voucher Tbk reimpresion
             	 */             	 
             	 vista.getOperTRV().getDatos().setValue("idTrxTbk",urlVC.getValor("NUMUNI"));
             	 vista.getOperTRV().getDatos().setValue("tipoTarjeta",this.data.getStringValue("TipoTotal"));
             	 
                 return 13 ; //ICajaView._NOWAITFORACTION;
...
//                this.setNombre("TarjetaTbkDirecto");
            ...
            case 101:
                ...
                */
                ...
                ParamSet posDat2 = Base.getParamSet("posDat");
                ParamSet pSet = Base.getParamSet( "posCfg" );
        		DatosFileNet datosFileNet = new DatosFileNet();
        		...
        		datosFileNet.setNumOperacion(posDat2.getStringValue("NumeroOperacion"));
    ...
    /**
     * Venta credito o debito
     */
	public static String ventaCredito(String ing4UD,String ingMonto,
	...
	public static String leerTarjeta(String ingMonto,
		...
		Base.logger.info("P I N P A D - lee tarjeta");
...
//    		mp.setTipoTotal("2");
    		...
    		//String[] tipoTotalTarjeta = obtenerTipoTotalTarjeta(this.getDatos().getStringValue("TipoTarjeta"));
    	...
    	/**
    	if(this.getDatos().getStringValue("TipoTotal").equals("TD")){
    		// Validar cual debe ser el tipo total para Debito ?
        	// mp.setTipoTotal("1007");
        	mp.setTipoTotal("7");
    	}
    	else{
    		// Validar cual debe ser el tipo total para Credito ??
