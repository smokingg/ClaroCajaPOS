 ...
 *
 */
public class ChequeOffline extends ChequeBaseOffline implements ITrxBase{
    ...
    public int execute(ICajaView vista, int key, Datos data){ 
        ...
        switch( estado ) {
            ...
            case 2:
                ...
                int codigo = this.etapaCreacionServicio(vista, this._CHEQUE_DIA);
            ...
            case 10:
            	//Para el franqueo de cheques se debe obtener el numero de operacion.
            		...
            		vista.getDatos().setValue("numOper__",new Long(1));
            		this.datos.setValue("numOper__", new Long(1));
            		Base.logger.info("Numero de Operacion obtenida para franqueo: " + vista.getDatos().getLongValue("numOper__"));
            		vista.getDatos().setValue("numOperRes__", new Long(0));
            		this.datos.setValue("numOperRes__", new Long(0));
