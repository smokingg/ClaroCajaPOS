...
public class OperReversaTbk extends OperReversa {
    /**
     * 
     */
    ...
    public OperReversaTbk(){
        this.setServicio("EnvioReversaTbk");
    }
    public void init(){
        
    }
    public int execute(Datos htParam){
        this.datos = new Datos(Base.getDefServicio("EnvioReversaTbk").getInputRecordDef());
