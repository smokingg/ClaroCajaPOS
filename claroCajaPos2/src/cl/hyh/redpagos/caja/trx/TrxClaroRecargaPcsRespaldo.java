...
/**
 * Esta clase implementa la recarga para Vtr y esta dentro del Demo para Claro !!
 * se debe refactorizar su nombre ??
 * @author cbriones
 *
 */
public class TrxClaroRecargaPcsRespaldo implements ITrxBase{
    int estado = 0;
    String codigo = "";
    Datos data;
    long celular= 0;
    ...
    public int execute(ICajaView vista, int key, Datos datos){ 
        ...
        switch( estado ) {
            case 0:
                ...
                vista.setEntryTextLabel("Ingrese Número PCS:", true);
