...
public class TrxConsultaTotalesCaja implements ITrxBase{
    int estado;
    Datos data;
        ...
        switch( estado ) {
            case 0:
                ...
                for(int j = 0; j < matrix.length; j++){
                    ...
                    matrix[j][2] = String.format("  %16s",Format.formatMonto(totales.get(j).getLongValue("Monto")));
                }
            ...
            case 1:
                ...
                voucher.add(this.getLinea("COMPROBANTE CIERRE CAJA", true, false, false, true));
